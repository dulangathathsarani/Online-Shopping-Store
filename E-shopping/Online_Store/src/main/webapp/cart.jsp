...
<body>
	...
	<header>
		...
		<nav>
			<ul>
				<li><a href="Controller?page=all-products">All Products</a></li>
				<c:choose>
		...
		<c:forEach items="${cartlist }" var="i">
			...
			<table style="table-layout: fixed;width: 100%;">
				<tr>
					...
					<td style="width: 100px;"><a style="color: red;" href="Controller?page=remove&id=<c:out value="${Product.getId()}"/>">Remove Item</a></td>
				</tr>
			</table>
				</c:if>
			</c:forEach>
	...
	<h4 style="margin-top: 40px;margin-bottom: 40px;">Order Total: Rs.(<c:out value="${ total}"></c:out>)</h4>
	...
	<a href="Controller?page=all-products"><input type="button" value="Continue Shopping" class="btn btn-warning" style="width:100%;padding:8px;font-size:16px;"></a>
